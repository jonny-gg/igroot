...
var NotFound = require('/Users/guoqn/workspace/igroot/site/theme/template/NotFound');
var themeConfig = JSON.parse('{"categoryOrder":{"设计原则":2,"Principles":2},"typeOrder":{"General":0,"Layout":1,"Navigation":2,"Data Entry":3,"Data Display":4,"Feedback":5,"Localization":6,"Other":7},"docVersions":{}}');
...
module.exports = function getRoutes(data) {
  function templateWrapper(template) {
    ...
    var Template = require('/Users/guoqn/workspace/igroot/site/theme/template' + template.replace(/^\.\/template/, ''));
  ...
  var theme = require('/Users/guoqn/workspace/igroot/site/theme');
