...
if (fs.existsSync(path.join(__dirname, '../dist'))) {
  // Build a entry less file to dist/igroot.less
  ...
  fs.readdir(componentsPath, function (err, files) {
    ...
    // Build less entry file: dist/igroot.less
    fs.writeFileSync(
      path.join(process.cwd(), 'dist', 'igroot.less'),
      '@import "../lib/style/index.less";\n@import "../lib/style/components.less";'
    );
  });
  console.log('Built a entry less file to dist/igroot.less');
}
