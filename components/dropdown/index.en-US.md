...
You can get the menu list by `igroot.Menu`, and set a callback function `onSelect` for it if you need. The menu items and the dividers are also available, by using `igroot.Menu.Item` and `igroot.Menu.Divider` respectively.
