    ...
    const list = [
      {
        ...
        status: 'done',
        uid: '-3',
        url: 'https://cdn.baishancloud.com/aaa.zip',
      ...
      },
      {
        ...
        status: 'done',
        uid: '-4',
        url: 'https://cdn.baishancloud.com/aaa',
      },
      {
        name: 'not-image',
        status: 'done',
        uid: '-5',
        url: 'https://cdn.baishancloud.com/aaa.xx',
      },
      {
        name: 'not-image',
        status: 'done',
        uid: '-6',
        url: 'https://cdn.baishancloud.com/aaa.png/xx.xx',
      },
      {
        name: 'image',
        status: 'done',
        uid: '-7',
        url: 'https://cdn.baishancloud.com/xx.xx/aaa.png',
      },
      {
        name: 'image',
        status: 'done',
      ...
      },
      {
        ...
        status: 'done',
        uid: '-9',
        url: 'https://cdn.baishancloud.com/xx.xx/aaa.png?query=123',
      },
      {
        name: 'image',
        status: 'done',
        uid: '-10',
        url: 'https://cdn.baishancloud.com/xx.xx/aaa.png#anchor',
      },
      {
        name: 'image',
        status: 'done',
        uid: '-11',
        url: 'https://cdn.baishancloud.com/xx.xx/aaa.png?query=some.query.with.dot',
      },
      {
        name: 'image',
        status: 'done',
