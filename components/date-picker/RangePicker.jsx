...
export default class RangePicker extends React.Component {
    constructor(props) {
        ...
        {renderExtraFooter(...args)}
            ...
            const operations = Object.keys(ranges || {}).map((range) => {
                ...
                return (<a key={range} onClick={() => this.setValue(value, true)} onMouseEnter={() => this.setState({ hoverValue: value })} onMouseLeave={this.clearHoverValue}>
          {range}
        </a>);
            });
    ...
    render() {
        ...
        return (<span ref={this.savePicker} className={classNames(props.className, props.pickerClass)} style={Object.assign({}, style, pickerStyle)} tabIndex={props.disabled ? -1 : 0} onFocus={props.onFocus} onBlur={props.onBlur}>
