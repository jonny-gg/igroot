...
export default function createPicker(TheCalendar) {
    return _a = class CalenderWrapper extends React.Component {
            ...
            render() {
                ...
                const input = ({ value: inputValue }) => (<span>
          <input disabled={props.disabled} readOnly={true} value={(inputValue && inputValue.format(props.format)) || ''} placeholder={placeholder} className={props.pickerInputClass}/>
          {clearIcon}
          <span className={`${prefixCls}-picker-icon`}/>
                ...
                return (<span className={props.pickerClass} style={assign({}, props.style, pickerStyle)}>
          <RcDatePicker {...props} {...pickerChangeHandler} calendar={calendar} value={pickerValue} prefixCls={`${prefixCls}-picker-container`} style={props.popupStyle}>
            {input}
          </RcDatePicker>
        </span>);
            }
